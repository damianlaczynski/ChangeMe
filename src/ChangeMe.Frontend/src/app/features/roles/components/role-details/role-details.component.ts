...
export class RoleDetailsComponent {
  ...
  constructor() {
    ...
    this.usersSearchControl.valueChanges
      ...
      .subscribe(() => this.loadAssignedUsers());
  }
  ...
  private loadAssignedUsers(): void {
    ...
    const search = this.usersSearchControl.value.trim();

    this.rolesService.getRoleAssignedUsers(this.id(), search || undefined).subscribe({
      next: (users) => {
