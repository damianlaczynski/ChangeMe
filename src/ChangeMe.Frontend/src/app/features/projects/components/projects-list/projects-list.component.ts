...
type ProjectSortField = 'Name' | 'Key' | 'Issues' | 'Members' | 'Status';
...
export class ProjectsListComponent {
  ...
  readonly canCreateProjects = computed(() =>
    this.authService.hasPermission(PermissionCodes.projectsManage)
  );
  ...
  openProjectActionsMenu(event: Event, project: ProjectListItemDto): void {
    ...
    if (canManageProjectResource(project.currentUserRole)) {
      items.push(
        {
