...
{
    /// <inheritdoc />
    public partial class AddProjectsAndIssueProjectMembership : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedProfileEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignInMethod = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasskeyStepUpCompletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PendingNewEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: true),
                    PendingNewEmailNormalized = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: true),
                    PendingEmailChangeRequestedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "webauthn_ceremony_pending",
                schema: "changeme_backend",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    CeremonyType = table.Column<int>(type: "integer", nullable: false),
                    OptionsJson = table.Column<string>(type: "character varying(64000)", maxLength: 64000, nullable: false),
                    FailedAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    ExpiresAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_webauthn_ceremony_pending", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageContainer = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_attachments_issues_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                name: "project_membership_history",
                schema: "changeme_backend",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_project_membership_history", x => x.Id);
                    table.ForeignKey(
                        name: "FK_project_membership_history_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalSchema: "changeme_backend",
                        principalTable: "projects",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                name: "project_operation_history",
                schema: "changeme_backend",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_project_operation_history", x => x.Id);
                    table.ForeignKey(
                        name: "FK_project_operation_history_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalSchema: "changeme_backend",
                        principalTable: "projects",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastProviderEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthenticatorType = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailedAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    ExpiresAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PendingSignInMethod = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_account_invitations_Id",
                schema: "changeme_backend",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attachments_StorageContainer_OwnerId_StorageKey",
                schema: "changeme_backend",
                table: "attachments",
                columns: new[] { "StorageContainer", "OwnerId", "StorageKey" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_project_membership_history_Id",
                schema: "changeme_backend",
                table: "project_membership_history",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_project_membership_history_ProjectId",
                schema: "changeme_backend",
                table: "project_membership_history",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_project_operation_history_Id",
                schema: "changeme_backend",
                table: "project_operation_history",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_project_operation_history_ProjectId",
                schema: "changeme_backend",
                table: "project_operation_history",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_webauthn_ceremony_pending_ExpiresAtUtc",
                schema: "changeme_backend",
                table: "webauthn_ceremony_pending",
                column: "ExpiresAtUtc");
        }
