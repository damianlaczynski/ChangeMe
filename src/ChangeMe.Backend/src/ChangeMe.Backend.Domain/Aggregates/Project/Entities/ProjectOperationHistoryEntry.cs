...
public class ProjectOperationHistoryEntry : Entity
{
  private ProjectOperationHistoryEntry() { }

  public Guid ProjectId { get; private set; }
  public ProjectOperationHistoryEventType EventType { get; private set; }
  public Guid ActorUserId { get; private set; }
  public string Summary { get; private set; } = string.Empty;
  public string? PreviousValue { get; private set; }
  public string? CurrentValue { get; private set; }

  public static Result<ProjectOperationHistoryEntry> Create(
    Guid projectId,
    ...
    string? currentValue = null)
  {
    ...
    return Result.Success(new ProjectOperationHistoryEntry
    {
      ProjectId = projectId,
      EventType = eventType,
...
public static class ProjectHistoryConstraints
{
