...
| _Complete your account setup using the invitation link_ | Invite pending (`Has password set` false)               | User must open invitation email, not external login alone.                                     |
