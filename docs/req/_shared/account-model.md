...
| **Employment profile**       | **User details** — **Employment** (REQ-BIL-003)                                                 | Administrator-maintained billing identity: **Employee ID**, **National ID**, **Tax ID**, **Bank account**, **Employment notes**. Not shown on **My account** except **Employment summary** (position and contract dates). |
| **Employment contract**      | **User details** — **Employment**; **My account** — **Employment summary**                      | Active or historical contract with **Position**, **Contract type**, **FTE**, **Monthly hours norm**, and compensation. Full contract list is admin-only.                                                                  |
| **Leave balance**            | **My leave** (REQ-BIL-006)                                                                      | **Entitled days**, **Used days**, and **Remaining days** for the current year when an active contract exists.                                                                                                             |
