...
| Path                                                           | Behavior                                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Register** — **Continue with {Display name}** (REQ-AUTH-014) | Allowed. Verified provider email matching the existing account links the provider and signs the user in (existing external-only path for users without a local password). **Status** becomes **`Active`**.                                                                                                  |
...
| **Login** — external sign-in                                   | Same linking rules as on **Register** when the email matches.                                                                                                                                                                                                                                               |
