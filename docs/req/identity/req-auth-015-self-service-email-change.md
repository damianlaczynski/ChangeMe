...
domain: identity
status: active
depends_on: [REQ-AUTH-001, REQ-AUTH-006, REQ-AUTH-007, REQ-AUTH-010, REQ-AUTH-011, REQ-AUTH-013, REQ-AUTH-014, REQ-PKY-001, REQ-USR-001, REQ-USR-003, REQ-USR-004]
---
## Goal
...
| **Register** (REQ-AUTH-001)           | May create an account whose **Profile email** equals another user's **pending new email**; that pending change is unchanged until confirm or cancel.              |
