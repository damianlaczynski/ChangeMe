...
- When **Combined account compliance gates** (`docs/req/_shared/compliance-gates.md`) (REQ-AUTH-013) also apply, **Required password change** takes precedence over two-factor verification and **strict two-factor setup** until the password is updated.
