...
| ID             | Given                                                                                                                                                                | When                                                                                                                                                         | Then                                                                                                                                                                                                                                                                                         |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AC-AUTH-013-01 | Guest on **Login**; primary authentication succeeded; account **Two-factor enabled** is **true**                                                                     | User reaches **Two-factor verification** and submits valid **Verification code**                                                                             | Session created; normal post-sign-in flow continues (password expiration, **Issues list**, etc.)                                                                                                                                                                                             |
| AC-AUTH-013-02 | Guest on **Two-factor verification**; pending sign-in challenge active                                                                                               | User submits invalid **Verification code** five times                                                                                                        | Challenge invalidated; redirected to **Login** with message `Too many attempts. Sign in again.`                                                                                                                                                                                              |
| AC-AUTH-013-03 | Guest on **Two-factor verification**; pending sign-in challenge older than **10 minutes**                                                                            | User attempts verification                                                                                                                                   | Redirected to **Login** with message `Sign-in timed out. Try again.`                                                                                                                                                                                                                         |
| AC-AUTH-013-04 | Signed-in user on **My account**; **Two-factor authentication enabled** is **true**; **Two-factor enabled** is **false**                                             | User clicks **Enable two-factor authentication**                                                                                                             | **Set up two-factor authentication** opens; on successful **Confirm setup** with valid **Verification code**, **Two-factor enabled** set true, **10** recovery codes generated and shown once; message `Two-factor authentication enabled.`; **Two-factor enabled** email sent (FR-AUTH-007) |
| AC-AUTH-013-05 | Signed-in user on **My account**; **Two-factor enabled** is **true**; **Two-factor authentication required** is **false**                                            | User clicks **Disable two-factor authentication** and completes **Sensitive account actions** step-up                                                        | **Two-factor enabled**, secret, and recovery codes cleared; message `Two-factor authentication disabled.`; **Two-factor disabled** email sent (FR-AUTH-007)                                                                                                                                  |
| AC-AUTH-013-06 | Signed-in user on **My account**; **Two-factor authentication required** is **true**                                                                                 | User views two-factor section                                                                                                                                | **Disable two-factor authentication** is **not available**                                                                                                                                                                                                                                   |
| AC-AUTH-013-07 | **Two-factor authentication required** is **true**; user **Two-factor enabled** is **false**; primary authentication just succeeded; IdP MFA does not satisfy policy | Sign-in completes primary auth                                                                                                                               | Client enters **strict two-factor setup** mode: cannot navigate to other screens until setup completes (except **Logout**); minimal chrome only                                                                                                                                              |
| AC-AUTH-013-08 | User in **strict two-factor setup** after sign-in                                                                                                                    | User completes **Set up two-factor authentication** successfully                                                                                             | Application opens **Issues list**, subject to **Combined account compliance gates** (`docs/requirements/_shared/reference/compliance-gates.md`)                                                                                                                                              |
| AC-AUTH-013-09 | Signed-in user with **Two-factor enabled** true                                                                                                                      | User clicks **Regenerate recovery codes** and completes step-up                                                                                              | Previous recovery codes invalidated; **10** new codes shown once; message `Recovery codes regenerated.`                                                                                                                                                                                      |
| AC-AUTH-013-10 | Guest or signed-in user submits a recovery code that was already used successfully                                                                                   | Code is submitted again                                                                                                                                      | Code rejected; **Recovery code used** email **not** sent again for the reuse attempt                                                                                                                                                                                                         |
| AC-AUTH-013-11 | Guest or signed-in user consumes an unused recovery code at sign-in or step-up                                                                                       | Code succeeds                                                                                                                                                | Code invalidated; **Recovery code used** email sent to **Profile email** (FR-AUTH-007)                                                                                                                                                                                                       |
| AC-AUTH-013-12 | Administrator with **Users.Manage** on **User details** (FR-USR-004); target **Two-factor enabled** is **true**; **Two-factor authentication enabled** is **true**   | User clicks **Reset two-factor** and confirms dialog `Reset two-factor authentication for "{full name}"? They will need to set it up again on next sign-in.` | **Two-factor enabled**, secret, and recovery codes cleared; all active sessions revoked; message `Two-factor authentication reset.`; **Two-factor reset by admin** email sent (FR-AUTH-007)                                                                                                  |
