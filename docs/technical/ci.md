...
| Security checks               | `npm run security:quick` or `npm run security` (see [security-checks.md](security-checks.md)) |
| SonarQube code quality        | `npm run sonar` (see [sonar-analysis.md](sonar-analysis.md))                                  |
